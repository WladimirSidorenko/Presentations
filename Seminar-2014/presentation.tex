...
\begin{frame}{}
  \normquestions{\alt<4->{\newline$\approx\frac{1}{10}$ of all tokens,
      ...
      normalization}{\newline$\approx\frac15$ of all tokens, $\approx\frac12$
      of all types are unknown}}{\begin{itemize}
      \item<2-> \genrespecifics;
      \item<3-> Deviating spellings;
  \end{itemize}}{\begin{itemize}
      \item<5-> \genrespecifics?\only<6->{ - rule-based}
      \item<5-> Intended spelling deviations?
      \item<5-> Unintended spelling deviations?
  \end{itemize}}{}
\end{frame}
...
\begin{frame}{Evaluation}
  ...
  \end{itemize}}{\begin{itemize}
      ...
      \item Unintended spelling deviations?- statistically/ML
  \end{itemize}}{\begin{itemize}\pause
      \item<+-> intrinsically (OOV-rate, precision, recall, F-measure)
      \item<+-> extrinsically (Performance and quality of succeeding analysis modules)
  \end{itemize}}
\end{frame}
